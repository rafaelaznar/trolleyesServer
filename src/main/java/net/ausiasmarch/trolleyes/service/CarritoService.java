...
import net.ausiasmarch.trolleyes.Exception.CarritoVacioEnCompraException;
import net.ausiasmarch.trolleyes.Exception.FaltaCantidadDeProductoEnCompraException;
import net.ausiasmarch.trolleyes.Exception.UnauthorizedException;
import net.ausiasmarch.trolleyes.entity.CarritoEntity;
import net.ausiasmarch.trolleyes.entity.CompraEntity;
...
import net.ausiasmarch.trolleyes.repository.CarritoRepository;
import net.ausiasmarch.trolleyes.repository.CompraRepository;
